...
namespace Tests
{
    ...
    public class BufferBuilderTests
    {
        ...
        public void Init()
        {
            ...
            _bufferBuilder = new BufferBuilder(_handler, 10);
        }

        [Test]
        public void Add()
        {
            Assert.AreEqual(10, _bufferBuilder.Capacity);
            ...
            Assert.AreEqual(_handler.Buffer, Encoding.UTF8.GetBytes("111222333"));
        }
